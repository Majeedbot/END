...
elseif UserID == 517537234 or UserID == 517537234  then  
...
if UserID == 517537234 or UserID == 517537234 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 517537234 or UserID == 517537234 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
return '- اصداااار سورس الزعيم : *v'..version..'* '
end
---aaa---
if MsgText[1] == 'تحديث السورسس' then
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
return "- الاصدار بصمة مجيد الحالي : *v"..version.."* \n- لديـك احدث اصدار "
end
return false
end
if text == 'تحديث السورس ⌯' and msg.SudoBase then 
os.execute('rm -rf Script.lua')
os.execute('wget https://raw.githubusercontent.com/Majeedbot/boo/main/inc/Script.lua')
...
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://1111/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 517537234 or UserID == 517537234 then 
...
if FwdUser == 517537234 or FwdUser == 517537234 then 
